...
export const actions = {
    ...
    nuxtServerInit({commit}, {req}) {
        ...
        const favorites = cookieFromRequest(req, 'favorites')
        if (favorites && typeof favorites !== "undefined") {
            commit('favorite/SET_FAVORITES', {items: JSON.parse(decodeURIComponent(favorites))})
        }
    },
