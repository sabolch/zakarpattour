        ...
        <v-flex xs12>
            ...
            <v-dialog v-model="savedialog" persistent max-width="600px">
                <v-card>
                    ...
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn outline color="blue darken-1" flat @click="savedialog = false">{{$t('btns.close')}}
                        </v-btn>
                        <v-btn :loading="form.busy" outline color="green darken-1" flat @click="saveCategory">
                            {{$t('btns.save')}}
                        </v-btn>
                    </v-card-actions>
                </v-card>
    ...
    export default {
        ...
        methods: {
            async responseSettlement() {
                let url = `settlement?page=${this.page}&limit=${this.tablePagination.rowsPerPage}`
